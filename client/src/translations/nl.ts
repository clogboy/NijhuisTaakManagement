export const nlTranslations = {
  ...
  activities: {
    ...
    searchContacts: "Zoek Microsoft contacten...",
  ...
  settings: {
    ...
    calendarSync: "Kalender synchronisatie",
    ...
    aiKeyStatus: "AI-sleutel status",
    primaryKey: "Primaire sleutel",
    backupKey: "Backup sleutel",
    exportData: "Gegevens exporteren",
  ...
  subtasks: {
    ...
    complete: "Voltooien",
    typeTask: "Taak",
    typeQuickWin: "Quick Win", 
    typeRoadblock: "Wegversperring",
    statusPending: "In afwachting",
    statusInProgress: "In uitvoering",
    statusCompleted: "Voltooid",
    editSubtask: "Subtaak bewerken",
    updateSuccess: "Subtaak succesvol bijgewerkt",
    updateFailed: "Subtaak bijwerken mislukt",
    deleteSuccess: "Subtaak succesvol verwijderd",
    deleteFailed: "Subtaak verwijderen mislukt",
    deleteConfirm: "Weet je zeker dat je deze subtaak wilt verwijderen?",
    priorityLow: "Laag",
    priorityNormal: "Normaal",
    priorityUrgent: "Urgent"
  },
